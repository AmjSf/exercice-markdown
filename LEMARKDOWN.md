...
Contrairement au langage HTML reposant sur l'usage de balises, le Markdown a pour but de permettre une meilleure ̩criture et une plus grande lisibilit̩ du contenu, le tout offrant un moyen de conversion plus simple.</br>
 
Le Markdown est utilis̩ dans plusieurs applications, soit sous la forme d'un ̩diteur de texte compatible, soit directement sur Internet. Certains services de blogs ou de r̩seaux sociaux souhaitant offrir une option de mise en forme des publications un peu plus riche reposent sur ce langage, c'est le cas par exemple de Google+.
## A quoi sert le Markdown ?
- Pouvoir cr̩er facilement des ̩l̩ments
- Ajouter simplement une mise en forme de text
- Avoir un mise en page rapidement
## Les dif̩rents ̩l̩ments
